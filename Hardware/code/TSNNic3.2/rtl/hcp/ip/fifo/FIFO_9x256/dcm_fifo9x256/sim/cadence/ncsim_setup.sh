...
mkdir -p ./libraries/dcm_fifo9x256_fifo_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_191/sim/dcm_fifo9x256_fifo_191_53aeptq.v" -work dcm_fifo9x256_fifo_191 -cdslib ./cds_libs/dcm_fifo9x256_fifo_191.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dcm_fifo9x256.v"                                                                                                                
fi
