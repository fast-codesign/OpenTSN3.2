	component ram_62_256 is
		port (
			data_a    : in  std_logic_vector(61 downto 0) := (others => 'X'); -- datain_a
			data_b    : in  std_logic_vector(61 downto 0) := (others => 'X'); -- datain_b
			...
			q_a       : out std_logic_vector(61 downto 0);                    -- dataout_a
			q_b       : out std_logic_vector(61 downto 0)                     -- dataout_b
		);
	end component ram_62_256;

	u0 : component ram_62_256
		port map (
