	component sdprf16x23_s is
		port (
			data      : in  std_logic_vector(22 downto 0) := (others => 'X'); -- datain
			...
			q         : out std_logic_vector(22 downto 0)                     -- dataout
		);
	end component sdprf16x23_s;

	u0 : component sdprf16x23_s
		port map (
