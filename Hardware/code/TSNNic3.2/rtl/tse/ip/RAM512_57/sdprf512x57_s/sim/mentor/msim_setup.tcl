...
# ----------------------------------------
# If sdprf512x57_s is one of several IP cores in your
...
# ----------------------------------------
# ACDS 19.1 670 win32 2021.06.24.15:03:48
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sdprf512x57_s"
}
...
ensure_lib                             ./libraries/sdprf512x57_s_ram_2port_191/
vmap       sdprf512x57_s_ram_2port_191 ./libraries/sdprf512x57_s_ram_2port_191/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_191/sim/sdprf512x57_s_ram_2port_191_xvvq7qa.v" -work sdprf512x57_s_ram_2port_191
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/sdprf512x57_s.v"                                                                             
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L sdprf512x57_s_ram_2port_191 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L sdprf512x57_s_ram_2port_191 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
