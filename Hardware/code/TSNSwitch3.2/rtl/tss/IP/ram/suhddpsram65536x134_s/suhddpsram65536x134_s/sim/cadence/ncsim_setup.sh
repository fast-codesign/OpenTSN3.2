...
TOP_LEVEL_NAME="suhddpsram65536x134_s"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="E:/altera/quartus19.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/suhddpsram65536x134_s_ram_2port_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_191/sim/suhddpsram65536x134_s_ram_2port_191_pu2i72y.v" -work suhddpsram65536x134_s_ram_2port_191 -cdslib ./cds_libs/suhddpsram65536x134_s_ram_2port_191.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/suhddpsram65536x134_s.v"                                                                                                                                                    
fi
