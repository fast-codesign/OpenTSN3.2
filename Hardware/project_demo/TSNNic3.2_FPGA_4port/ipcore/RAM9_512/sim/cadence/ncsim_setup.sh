...
mkdir -p ./libraries/RAM9_512_ram_2port_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_191/sim/RAM9_512_ram_2port_191_fb4km7q.v" -work RAM9_512_ram_2port_191 -cdslib ./cds_libs/RAM9_512_ram_2port_191.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/RAM9_512.v"                                                                                                                          
fi
