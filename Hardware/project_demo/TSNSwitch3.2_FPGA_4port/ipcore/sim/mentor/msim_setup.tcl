...
# ----------------------------------------
# If dcm_fifo9x256 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 19.1 670 win32 2021.01.23.16:11:07
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "dcm_fifo9x256"
}
...
ensure_lib                        ./libraries/dcm_fifo9x256_fifo_191/
vmap       dcm_fifo9x256_fifo_191 ./libraries/dcm_fifo9x256_fifo_191/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_191/sim/dcm_fifo9x256_fifo_191_53aeptq.v" -work dcm_fifo9x256_fifo_191
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dcm_fifo9x256.v"                                                              
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L dcm_fifo9x256_fifo_191 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L dcm_fifo9x256_fifo_191 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
