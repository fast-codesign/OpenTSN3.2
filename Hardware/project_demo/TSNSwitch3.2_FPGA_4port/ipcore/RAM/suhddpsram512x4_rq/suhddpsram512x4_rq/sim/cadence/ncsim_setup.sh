...
TOP_LEVEL_NAME="suhddpsram512x4_rq"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/suhddpsram512x4_rq_ram_2port_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_191/sim/suhddpsram512x4_rq_ram_2port_191_gytxvfq.v" -work suhddpsram512x4_rq_ram_2port_191 -cdslib ./cds_libs/suhddpsram512x4_rq_ram_2port_191.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/suhddpsram512x4_rq.v"                                                                                                                                              
fi
