...
# ----------------------------------------
# If suhddpsram65536x134_s is one of several IP cores in your
...
# ----------------------------------------
# ACDS 19.1 670 win32 2020.10.17.10:58:53
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "suhddpsram65536x134_s"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "E:/altera/quartus19.1/quartus/"
}
...
ensure_lib                                     ./libraries/suhddpsram65536x134_s_ram_2port_191/
vmap       suhddpsram65536x134_s_ram_2port_191 ./libraries/suhddpsram65536x134_s_ram_2port_191/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../ram_2port_191/sim/suhddpsram65536x134_s_ram_2port_191_pu2i72y.v" -work suhddpsram65536x134_s_ram_2port_191
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/suhddpsram65536x134_s.v"                                                                                     
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L suhddpsram65536x134_s_ram_2port_191 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L suhddpsram65536x134_s_ram_2port_191 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver $TOP_LEVEL_NAME
}
