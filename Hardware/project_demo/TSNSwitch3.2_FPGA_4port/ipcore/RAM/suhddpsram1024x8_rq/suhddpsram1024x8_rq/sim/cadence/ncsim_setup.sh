...
TOP_LEVEL_NAME="suhddpsram1024x8_rq"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/suhddpsram1024x8_rq_ram_2port_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_191/sim/suhddpsram1024x8_rq_ram_2port_191_go2l72y.v" -work suhddpsram1024x8_rq_ram_2port_191 -cdslib ./cds_libs/suhddpsram1024x8_rq_ram_2port_191.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/suhddpsram1024x8_rq.v"                                                                                                                                                
fi
