...
TOP_LEVEL_NAME="suhddpsram16384x9_s"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/suhddpsram16384x9_s_ram_2port_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_191/sim/suhddpsram16384x9_s_ram_2port_191_emqbfsi.v" -work suhddpsram16384x9_s_ram_2port_191 -cdslib ./cds_libs/suhddpsram16384x9_s_ram_2port_191.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/suhddpsram16384x9_s.v"                                                                                                                                                
fi
