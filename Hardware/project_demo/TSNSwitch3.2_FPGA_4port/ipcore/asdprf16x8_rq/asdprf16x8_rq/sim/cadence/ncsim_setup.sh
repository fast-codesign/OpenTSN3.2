...
mkdir -p ./libraries/asdprf16x8_rq_ram_2port_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../ram_2port_191/sim/asdprf16x8_rq_ram_2port_191_2sgz4hi.v" -work asdprf16x8_rq_ram_2port_191 -cdslib ./cds_libs/asdprf16x8_rq_ram_2port_191.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/asdprf16x8_rq.v"                                                                                                                                    
fi
