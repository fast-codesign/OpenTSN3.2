...
#define INIT_MAX_NODE_NUM   50  /*最大初始转发表的数量为100*/
...
typedef struct
{
    u16 imac;
	u16 time_slot;
	u16 inject_slot_period;//最大1024
}init_test_info;
init_test_info init_test[INIT_TEST_NODE_NUM];
